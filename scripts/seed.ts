...
async function main() {
  ...
  for (const [name, slug, homeDescription, displayOrder] of brands) await upsert(payload, "brands", slug, { name, slug, homeDescription, fullDescription: homeDescription, logoUrl: slug === "harvest-and-field" ? "/brand/partners/harvest-and-field.png" : undefined, featured: true, displayOrder, status: "published" });
