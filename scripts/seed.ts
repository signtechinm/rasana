...
async function main() {
  ...
  const categories: Array<[string, string, string, number]> = [["Meat & poultry", "meat-poultry", "Selected proteins for foodservice and retail partners.", 1], ["Seafood", "seafood", "Trusted coastal and ocean harvest selections.", 2], ["Pantry", "pantry", "Essential ingredients with character and consistency.", 3]];
  ...
  const brands: Array<[string, string, string, number]> = [["Origin partners", "origin-partners", "Producers selected for craft, consistency, and point of view.", 1], ["North & coast", "north-and-coast", "A distinctive collection of coastal flavours and pantry staples.", 2]];
